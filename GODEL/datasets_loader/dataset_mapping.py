def _dataset_mapping_function(examples, tokenizer, padding,max_target_length,args,column_mapping):
...
def goal_directed_mapping_function(examples, tokenizer, padding,max_target_length,args):
    column_mapping={'input': 'Context','label':'Response','knowledge':'Knowledge'}
    return _dataset_mapping_function(examples, tokenizer, padding,max_target_length,args,column_mapping)

def chat_context_mapping_function(examples, tokenizer, padding,max_target_length,args):
